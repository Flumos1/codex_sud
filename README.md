...
See `docs/architecture-cloudflare-supabase.md` for the component map, `docs/cloudflare-supabase-deploy.md` for setup, and `docs/handoff-new-computer.md` when continuing from another computer.
